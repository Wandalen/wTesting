...
Визначає час затримки між завершенням тесту однієї тест рутини та запуском наступної. Цей час призначений для завершення виконання перевірок асинхронних функцій в попередній рутині перед запуском наступної.
...
Виконайте тестування всіх рутин в директорії `testOptions` командою `tst . sanitareTime:1000`. Порівняйте результат з приведеним.

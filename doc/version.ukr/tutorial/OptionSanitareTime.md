...
Опція `sanitareTime` визначає час затримки між завершенням тестування однієї тест рутини та запуском наступної. Цей час призначений для завершення виконання перевірок асинхронних функцій в тестованій рутині.

Значення опції вказується в мс. Якщо опція не встановлена, то за замовчуванням вона має значення 500мс.

...
- Визначити обмеження з якими працюватиме тест об'єкт.
- Написати юніт тести, котрі охоплюють базовий функціонал.
- Написати код, що забезпечує базовий функціонал.
- Розширювати код тест об'єкту і код тест рутини до забезпечення повної відповідності коду поставленими вимогам.
- У випадку необхідності згрупувати тест кейси в тест групи.
- За необхідності розширення поведінки тест об'єкта або знаходження багу, необхідно розширити тест рутину та внести зміни в код. 

### Формальні вимоги

- Для обраної рутини ( чи іншої функціональності ) тест об'єкта створюється окрема тест рутина.
...
- Для зручності назва тест рутини обирається аналогічно до назви рутини тест об'єкта. Якщо декілька тест рутин тестують один аспект тест об'єкта у них має бути спільний початок назви.

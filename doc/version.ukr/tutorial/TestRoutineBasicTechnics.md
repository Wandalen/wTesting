...
- Відсутність змішування тест кейсів
...
При створенні покриття для тест юніта слід орієнтуватись на його призначення і загальні особливості функціонування. Процес написання починається з базових випадків і поступово тест рутина ускладнюється новими тестовими випадками.

Наприклад, порядок створення покриття для рутини `arrayRemove`, котра видаляє указаний елемент з масиву:

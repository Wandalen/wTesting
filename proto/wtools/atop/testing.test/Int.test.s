...
function shouldThrowErrorAsync( test )
{
  ...
  function r1( t )
  {
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c2 = t.shouldThrowErrorAsync( () => { throw _.err( 'test' ) } );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c8 = t.shouldThrowErrorAsync( _.Consequence().take( 'arg' ) );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c9 = t.shouldThrowErrorAsync( _.Consequence().error( 'error1' ) );
      counter.acheck = t.checkCurrent();
...
function shouldThrowErrorOfAnyKindWithCallback( test )
{
  ...
  function r1( t )
  {
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c1 = t.shouldThrowErrorOfAnyKind( () => {}, onResult );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c4 = t.shouldThrowErrorOfAnyKind( () =>
      {
        return _.time.out( context.t1 );
      },
      onResult );
    ...
    ready.finally( ( err, arg ) =>
    {
      ...
      test.identical( errStack.length, 2 );
      test.identical( errStack[ 0 ], 'arg1' );
      test.identical( errStack[ 1 ], false );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c8 = t.shouldThrowErrorOfAnyKind( _.Consequence().take( 'arg' ), onResult );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c9 = t.shouldThrowErrorOfAnyKind( _.Consequence().error( 'error1' ), onResult );
...
function shouldThrowErrorOfAnyKind_WithCallback( test )
{
  ...
  function r1( t )
  {
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c1 = t.shouldThrowErrorOfAnyKind_( () => {}, onResult );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c2 = t.shouldThrowErrorOfAnyKind_( () =>
      {
        throw _.errBrief( 'err1' );
      },
      onResult );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c3 = t.shouldThrowErrorOfAnyKind_( () =>
      {
        return _.time.out( context.t1, () =>
        {
          throw _.errBrief( 'err1' );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c4 = t.shouldThrowErrorOfAnyKind_( () =>
      {
        return _.time.out( context.t1 );
      },
      onResult );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c5 = t.shouldThrowErrorOfAnyKind_( () =>
      {
        var con = _.Consequence();
        _.time.out( context.t1, () =>
        {
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c6 = t.shouldThrowErrorOfAnyKind_( () =>
      {
        var con = _.Consequence();
        _.time.out( context.t1, () =>
        {
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c8 = t.shouldThrowErrorOfAnyKind_( _.Consequence().take( 'arg' ), onResult );
    ...
    ready.then( () =>
    {
      ...
      t.identical( 0, 0 );
      c9 = t.shouldThrowErrorOfAnyKind_( _.Consequence().error( 'error1' ), onResult );
...
function onRoutineBeginThrowError( test )
{
  function trivial( t )
  {
    t.case = 'trivial'
  ...
  let onRoutineBeginErr = _.err( 'onRoutineBegin: some error' );

  function onRoutineBegin()
  {
    throw onRoutineBeginErr;
  }
  ...
  .finally( function( err, suites )
  {
    ...
    test.identical( got.outcome, false );
    test.identical( got.errorsArray, [ onRoutineBeginErr ] );
    test.identical( got.exitCode, 0 );
    test.identical( got.testCheckPasses, 1 );
    ...
    // test.identical( got.testCaseNumber, 0 );
    test.identical( got.testRoutinePasses, 0 );
    test.identical( got.testRoutineFails, 1 );
...
function onRoutineBeginReturnsNothing( test )
{
  function trivial( t )
  {
    t.case = 'trivial'
...
function onRoutineBeginErrorInConsequence( test )
{
  function trivial( t )
  {
    t.case = 'trivial'
  ...
  let ConError = _.err( 'Error from onRoutineBegin' )
...
function onRoutineBeginNormalConsequence( test )
{
  function trivial( t )
  {
    t.case = 'trivial'
...
function onRoutineBeginDelayedConsequence( test )
{
  function trivial( t )
  {
    t.case = 'trivial'
...
const Proto =
{
  ...
  tests :
  {
    ...
    onRoutineBeginThrowError,
    onRoutineBeginReturnsNothing,
    onRoutineBeginErrorInConsequence,
    onRoutineBeginNormalConsequence,
    onRoutineBeginDelayedConsequence,
